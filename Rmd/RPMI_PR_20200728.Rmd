...
```{r}
ggsave("~/GitHub/PR_Data_Gat201/RMPI_PR_Gat201_poster.png",width = 6.6,height=5)
```


## Plot OD all stat_summary(geom -"line")remove excess lines
...
ggplot(data=normalisedOD %>%
       ...
       stat_summary(fun = "median", geom = "line", size = 1) +
       scale_y_continuous(limits=c(0,0.1),expand=c(0,0), breaks = c(0, 0.05, 0.1)) +
  geom_vline(aes(xintercept=1), linetype="dotted", colour="black") +
       labs(x = "Number of Days",
            y = "Absorbance (595nm)",
            title = "Cell Culture Media") +
